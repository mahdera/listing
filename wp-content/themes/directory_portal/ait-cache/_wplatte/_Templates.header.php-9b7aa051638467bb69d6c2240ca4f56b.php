<?php //netteCache[01]000478a:2:{s:4:"time";s:21:"0.59544900 1425905980";s:9:"callbacks";a:3:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:89:"/Applications/MAMP/htdocs/listing/wp-content/themes/directory_portal/Templates/header.php";i:2;i:1425905951;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:30:"eee17d5 released on 2011-08-13";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:21:"WPLATTE_CACHE_VERSION";i:2;i:4;}}}?><?php

// source file: /Applications/MAMP/htdocs/listing/wp-content/themes/directory_portal/Templates/header.php

?><?php list($_l, $_g) = NCoreMacros::initRuntime($template, 'dykw2lpm0f')
;
// snippets support
...
<?php NCoreMacros::includeTemplate('snippets/social-icons.php', $template->getParams(), $_l->templates['dykw2lpm0f'])->render() ;NCoreMacros::includeTemplate('snippets/wpml-flags.php', $template->getParams(), $_l->templates['dykw2lpm0f'])->render() ?>
                            <!-- <?php NCoreMacros::includeTemplate('snippets/search-form.php', $template->getParams(), $_l->templates['dykw2lpm0f'])->render() ?> -->
                        </div>
                    </div>
<?php endif ?>
            </div>
...
<?php if (isset($isDirSingle)): NCoreMacros::includeTemplate('snippets/map-single-javascript.php', $template->getParams(), $_l->templates['dykw2lpm0f'])->render() ;else: if ($headerType == 'map'): NCoreMacros::includeTemplate('snippets/map-javascript.php', $template->getParams(), $_l->templates['dykw2lpm0f'])->render() ;endif ;endif ?>
